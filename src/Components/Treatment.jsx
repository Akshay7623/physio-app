                ...
                <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
                    <article className="mx-4 format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                        <header className="mb-4 lg:mb-6 not-format flex flex-row gap-10">
                            ...
                            <div>
                                <h1 className="mb-3 text-xl font-extrabold md:text-2xl leading-tight text-gray-900 lg:mb-4 lg:text-3xl dark:text-white">{capitalize(id)}</h1>
                            </div>
                        </header>
                        ...
                        <div className='text-base md:text-lg lg:text-xl mt-4 md:mt-10'>
                            <div className='leading-tight font-bold text-[#263238] md:mb-4'>Symptoms :</div>
                            <div className='mt-2 text-sm font-semibold md:text-base'>
                                {services[id].symptoms.map((val) => {
                                    return (
                        ...
                        <div className='text-base md:text-lg lg:text-xl mt-4 md:mt-10'>
                            <div className='leading-tight font-bold text-[#263238] md:mb-4'>Causes :</div>
                            <div className='mt-2 text-sm font-semibold md:text-base'>
                                {services[id].causes.map((val) => {
                                    return (
                                        <li className='mb-2' key={val} style={{ listStyleType: 'disc' }}>
                        ...
                        <div className='text-base md:text-lg lg:text-xl mt-4 md:mt-10'>
                            <div className='leading-tight font-bold text-[#263238] md:mb-4'>Risk Factors :</div>
                            <div className='mt-2 text-sm font-semibold md:text-base'>
                                {services[id]["risk factors"].map((val) => {
                                    return (
                                        <li className='mb-2' key={val} style={{ listStyleType: 'disc' }}>
                                            <span className='font-bold'>{val.split(':')[0]} :</span> {val.split(':')[1]}
                                        </li>
                        ...
                        <div className='text-base md:text-lg lg:text-xl mt-4 md:mt-10'>
                            <div className='leading-tight font-bold text-[#263238] md:mb-4'>Prevention :</div>
                            <div className='mt-2 text-sm font-semibold md:text-base'>
                                {services[id].prevention.map((val) => {
                                    return (
                                        <li className='mb-2' key={val} style={{ listStyleType: 'disc' }}>
                                            <span className='font-bold'>{val.split(':')[0]} </span> {val.split(':')[1]}
                                        </li>
