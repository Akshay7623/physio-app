...
const OrthopedicTherapy = (props) => {
    ...
    const healthConditions1 = ['achilles tendon rupture', 'ankle sprain', 'golfers elbow', 'sports rehab', 'tennis elbow']
...
export default OrthopedicTherapy;