...
const Appointments = () => {
  ...
  useEffect(() => {
    setIsLoading(true)
    if (page > 0) {
      fetch(GET_APPOINTMENTS + `/?page=${page}&appointment_type=all`, {
        method: "get",
        headers: {
  ...
  return (
    <>
      <SideDrwer title='Appointments' />
      <div className='mt-2 max-w-screen-xl mx-auto z-0'>

        <div className='mx-4'>

          <div className='flex flex-row justify-between'>
            <NavLink to='/admin/appointments/all'><Button variant="gradient" size='sm'>All</Button></NavLink>
