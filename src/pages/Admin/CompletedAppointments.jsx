...
const CompletedAppointments = () => {
    ...
    useEffect(() => {
        setIsLoading(true)
        if (page > 0) {
            fetch(GET_APPOINTMENTS + `/?page=${page}&appointment_type=completed`, {
                method: "get",
                headers: {
    ...
    return (
        <>
            <SideDrwer title='Completed Appointments' />
            <div className='mt-2 max-w-screen-xl mx-auto z-0'>
                ...
                <div className='mx-4'>
                    ...
                    <div className='flex flex-row justify-between'>
                        ...
                        <NavLink to='/admin/appointments/upcoming'><Button variant="outlined" size='sm'>Upcoming</Button></NavLink>
                        <NavLink to='/admin/appointments/completed'> <Button variant="gradient" size='sm'>Completed</Button></NavLink>
                    </div>
