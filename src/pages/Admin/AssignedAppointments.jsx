    ...
    const Assign = (id) => {
        ...
        fetch(ASSIGN_APPOINTMENT, {
            ...
            if (data.message === 'success') {
                ...
                fetch(GET_APPOINTMENTS + `/?page=${page}&appointment_type=upcoming&assigned=true`, {
                    method: "get",
                    headers: {
                        "Content-Type": "application/json",
                        'Authorization': `Bearer ${token}`
                ...
                <div className='mx-4'>
                    <div className='flex flex-row gap-4'>
                        <NavLink to='/admin/assign'>
                            <Button size='sm' variant='outlined'>assign Appointment</Button>
                        </NavLink>
                        <Button size='sm'>assigned Appointment</Button>
                    </div>
