...
function SideDrwer(props) {
    ...
    return (
        <>
            <div onClick={openDrawer} className="flex flex-row py-4 px-4 sticky top-0 bg-[#b2b2b2] gap-3 z-10">
                <div className="cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                        <path fillRule="evenodd" d="M3 5.25a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 5.25Zm0 4.5A.75.75 0 0 1 3.75 9h16.5a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 9.75Zm0 4.5a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75a.75.75 0 0 1-.75-.75Zm0 4.5a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75a.75.75 0 0 1-.75-.75Z" clipRule="evenodd" />
                    </svg>
                </div>
                <div className="text-white mt-0.5 font-semibold text-base">
                    {props?.title}
                </div>
            </div>
            ...
            <Drawer open={open} onClose={closeDrawer}>
                ...
                <List>
                    ...
                    <NavLink to='/admin/appointments/all'>
                        <ListItem>
                            <ListItemPrefix>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                <Button className="mt-3 ml-5 flex flex-row gap-2" size="sm" onClick={logout}>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
