        ...
        <>
            ...
            <div className='px-4 max-w-[900px] mx-auto'>
                ...
                <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
                    ...
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(1)}>1. What is physiotherapy, and how can it help me?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(2)}>2. Who can benefit from physiotherapy services?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(3)}>3. What are home visit physiotherapy services?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 4} icon={<Icon id={4} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(4)}>4. Who can benefit from home visit physiotherapy services?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 5} icon={<Icon id={5} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(5)}>5. How do I schedule a home visit appointment?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 6} icon={<Icon id={6} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(6)}>6. What should I expect during a home visit physiotherapy appointment?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 7} icon={<Icon id={7} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(7)}>7. Do I need to provide any equipment or materials for my home visit appointment?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 8} icon={<Icon id={8} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(8)}>8. What types of treatments are available during home visits?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                        Our physiotherapists can provide a wide range of treatments and interventions during home visits, including:
                        <div>
                            <b><li className='mt-1'>1. Therapeutic exercises and stretches</li></b>
                            <b><li className='mt-1'>2. Manual therapy techniques (e.g., massage, joint mobilization)</li></b>
                            <b><li className='mt-1'>3. Gait and balance training</li></b>
                            <b><li className='mt-1'>4. Pain management strategies</li></b>
                            <b><li className='mt-1'>5. Education on injury prevention and self-management techniques</li></b>
                        </div>
                    </AccordionBody>
                </Accordion>

                <Accordion open={open === 9} icon={<Icon id={9} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(9)}>9. What are the advantages of home visit physiotherapy services?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                        <div>
                            <b><li className='mt-1'>1. Convenience: Eliminates the need for travel to a clinic, saving time and energy.</li></b>
                            <b><li className='mt-1'>2. Comfort: Receive treatment in the familiar and relaxed environment of your own home.</li></b>
                            <b><li className='mt-1'>3. Personalized Care: Our physiotherapists can assess your home environment and tailor treatments to your specific needs and goals.</li></b>
                            <b><li className='mt-1'>4. Enhanced Compliance: Home visits can improve treatment adherence and compliance, leading to better outcomes for patients.</li></b>
                        </div>
                    </AccordionBody>
                </Accordion>

                <Accordion open={open === 10} icon={<Icon id={10} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(10)}>10. How can I provide feedback about my experience with physiotherapy services?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 11} icon={<Icon id={11} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(11)}>11. How many physiotherapy sessions will I need?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 12} icon={<Icon id={12} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(12)}>12. Is physiotherapy covered by insurance?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
                ...
                <Accordion open={open === 13} icon={<Icon id={13} open={open} />}>
                    <AccordionHeader className='py-2 faq_header text-sm md:text-base' onClick={() => handleOpen(13)}>13. What safety measures are in place to protect clients during physiotherapy sessions?</AccordionHeader>
                    <AccordionBody className='py-2 font-semibold text-sm md:text-base'>
